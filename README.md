...
window.SB\_URL = 'https://your-project.supabase.co';

window.SB\_KEY = 'your-anon-key';

window.ADMIN\_EMAIL = 'admin@example.com';
...
CREATE TABLE saved\_games (

&#x20; id TEXT PRIMARY KEY,

&#x20; game\_data JSONB NOT NULL,
...
ALTER TABLE saved\_games ENABLE ROW LEVEL SECURITY;



\-- Allow anonymous inserts/updates/deletes

CREATE POLICY "Allow all" ON saved\_games FOR ALL USING (true);



\-- Enable Realtime

ALTER PUBLICATION supabase\_realtime ADD TABLE saved\_games;
